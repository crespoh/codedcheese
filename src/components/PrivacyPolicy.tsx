    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto bg-surface border border-line rounded-2xl p-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-6">Privacy Policy for Spelling Assist</h1>
          <p className="text-sm text-ink-soft mb-8">Last updated: 2025-05-23</p>

          <h2 className="text-2xl font-semibold mb-4">Introduction</h2>
          <p className="text-lg mb-6">Your privacy is important to us. Spelling Assist does <b>not</b> collect, store, or transmit any personal data. All data you create remains on your device and is not shared with anyone. No analytics or tracking is performed.</p>

          <h2 className="text-2xl font-semibold mb-4">Data Collection</h2>
          <p className="text-lg mb-6">Spelling Assist does <b>not</b> collect any personal information, usage data, or technical data from users. All spelling lists, words, and app usage remain strictly local to your device.</p>
          ...
          <p className="text-lg mb-6">Spelling Assist does <b>not</b> use any analytics, tracking, or crash reporting tools. Your activity is never monitored or shared.</p>
